...
class LeftNav extends Component {
  componentDidMount() {
    ...
    for (let i = 1; i <= numPortraits; i++) {
      ...
      let style =
        portrait.currentStyle || window.getComputedStyle(portrait, false);
    ...
    this.selfPortrait.addEventListener("mousemove", (e) => {
      if (!portraitWait) {
        ...
        this.selfPortrait.style.backgroundImage =
          "url(" + this.selfPortraitUrls[index] + ")";
        ...
        <div className="info">
          ...
          <ul className="links">
            <li key="twitter">
              ...
              <a target="__blank" href="https://www.twitter.com/minqijiang">
                @MinqiJiang
              </a>
            </li>
            <li key="github">
              <div className="icon git-icon" />{" "}
              <a target="__blank" href="https://github.com/minqi">
                GitHub
              </a>
            </li>
            <li key="scholar" className="scholar-link">
              <div className="icon scholar-icon" />{" "}
              <a
                target="__blank"
                href="https://scholar.google.com/citations?user=b7LglM0AAAAJ"
              >
                Google Scholar
              </a>
            </li>
            <li key="email">
              ...
              <span className="email">me@minch.co</span>
            </li>
          </ul>
        </div>
      </div>
